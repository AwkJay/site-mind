  ...
  ncrs: [
    {
      ...
      citation: {
        ...
        verify_url:
          "https://archive.org/details/gov.in.is.456.2000",
      },
      why_it_matters:
    ...
    },
    {
      ...
      citation: {
        ...
        verify_url:
          "https://archive.org/details/gov.in.is.1893.1.2016",
      },
      why_it_matters:
      ...
      sources: [
        {
          ...
          verify_url: "https://archive.org/details/gov.in.is.456.2000",
        },
        {
      ...
      sources: [
        {
          ...
          verify_url: "https://archive.org/details/gov.in.is.875.3.2015",
        },
      ],
      seen_before: null,
    };
      ...
      sources: [
        {
          ...
          verify_url: "https://archive.org/details/gov.in.is.1893.1.2016",
        },
      ],
      seen_before: null,
    };
...
export const mockAuditEvents: AuditEvent[] = [
  {
    ...
    payload: {
      ...
      item: "Footing F-12",
      severity: "HIGH",
      finding: "Transformer-yard footing F-12 specifies nominal cover = 30 mm.",
      status: "OPEN",
    ...
    content_hash: "mock0000cover0000000000000000000000000000000000000000000000001",
    solana: { status: "pending" },
  },
  {
    id: "AUD-mockwc01",
    seq: 1,
    created_at: 1784799000,
    pillar: "compliance",
    kind: "ncr",
    ref_id: "NCR-0002",
    payload: {
      id: "NCR-0002",
      item: "Severe-exposure structural concrete (mix design)",
      severity: "HIGH",
      finding: "Free water-cement ratio for severe-exposure concrete specified as 0.55.",
      status: "OPEN",
      verdict_tier: "certified",
    },
    hashed_fields: {
    ...
    content_hash: "mock0000wcratio000000000000000000000000000000000000000000002",
    solana: { status: "anchored", tx_sig: "mockTxSigNotARealSolanaSignature", cluster: "devnet" },
  },
];
