        ...
        <div className="space-y-5">
          ...
          <Card className="px-5 py-4">
            ...
            <p className="mt-1 text-sm text-text-mid">
              Live corpus metadata straight from Codebook&rsquo;s own registry — <code className="font-mono text-text-hi">structural_standard_codes</code>,{" "}
          ...
          <Card className="px-5 py-4">
            ...
            >
              ...
              <input
                ...
                placeholder="corpus (optional, e.g. structural_standard_codes)"
