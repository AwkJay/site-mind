...
Standards (backend/data/standards/clauses.json) are REAL Codebook-cached clauses and
...
def gen_submittals() -> None:
    ...
    rows = [
        ["DC1-02-DBR-0001-R2", "R2", "Structural Design Basis Report",
         ...
         "A – Approved", 9],
        ["DC1-02-SD-0142-R1", "R1", "Foundation shop drawing — footing F-12 transformer yard",
         "03 30 00", "Structural", "SD", "L&T Construction", "2026-04-18",
         "C – Revise & Resubmit", 14],
        ["DC1-02-MOS-0210-R0", "R0", "Method statement — concrete mix for severe-exposure raft",
         "03 31 00", "Structural", "MOS", "L&T Construction", "2026-04-22",
         "C – Revise & Resubmit", 11],
        ["DC1-02-SD-0156-R0", "R0", "Reinforcement detailing — column C-08",
